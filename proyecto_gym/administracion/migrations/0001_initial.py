# Generated by Django 3.2.18 on 2023-06-20 21:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=100, verbose_name='Nombre')),
                ('dia', models.IntegerField(choices=[(0, '¡SELECCIONE EL DÍA!'), (1, 'Lunes'), (2, 'Martes'), (3, 'Miércoles'), (4, 'Jueves'), (5, 'Viernes'), (6, 'Sábado')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.IntegerField(choices=[(1, 'Inscripto, abono al día'), (2, 'Falta abonar la cuota')], default=1)),
